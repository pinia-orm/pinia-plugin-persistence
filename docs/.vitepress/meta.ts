export const name = 'pinia-plugin-persistence'
export const shortName = 'pinia-plugin-persistence'
export const description = 'Configurable persistence and rehydration of Pinia stores.'
