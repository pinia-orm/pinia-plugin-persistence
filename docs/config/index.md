...
- **type**: [`StorageLike`](https://github.com/elonehoo/pinia-plugin-persistence/blob/main/packages/core/src/types.ts#L3)
...
- **type**: [`Serializer`](https://github.com/elonehoo/pinia-plugin-persistence/blob/main/packages/core/src/types.ts#L5)
